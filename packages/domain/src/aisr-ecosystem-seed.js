...
export function createAisrEcosystemLayout() {
  return {
    ...
    nodes: [
      ...
      layoutNode('lifespace.client', 30, 580, 250, 130),
      ...
      layoutNode('aloha.contracts', 30, 580, 220, 120),
      layoutNode('aloha.capabilities', 280, 580, 220, 120),
      layoutNode('aloha.runtime-n8n', 30, 720, 600, 205),
      layoutNode('aloha.n8n-agent', 25, 85, 250, 92),
      layoutNode('aloha.lifespace-tool', 520, 80, 180, 104),
